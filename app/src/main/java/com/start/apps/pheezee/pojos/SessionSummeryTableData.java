...
public class SessionSummeryTableData {
    String patientid,phizioemail,injured_side,bodypart,bodyorientation,exercisename,musclename;

    public SessionSummeryTableData(String patientId, String phizioemail, String injured_side, String bodypart, String bodyorientation, String exercisename, String musclename) {
