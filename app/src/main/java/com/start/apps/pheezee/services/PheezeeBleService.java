...
public class PheezeeBleService extends Service {
    ...
    public void sendSessionDataBroadcast(){
        ...
        Log.e("7777777777777777777777777777777777777", String.valueOf(i));
        sendBroadcast(i);
    ...
    public void sendBodypartDataToDevice(String bodypart, int body_orientation, String patientName, int exercise_position,
                                         int muscle_position, int bodypart_position, int orientation_position,int max_angle,int min_angle,boolean Status){
        ...
        writeCharacteristic(mCustomCharacteristic, ValueBasedColorOperations.getParticularDataToPheeze(body_orientation,
                muscle_position, exercise_position, Bodypart_number.get(bodypart), orientation_position,max_angle,min_angle,Status),"AE");
    }
