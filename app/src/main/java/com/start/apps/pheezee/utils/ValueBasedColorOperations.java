...
public class ValueBasedColorOperations {
    ...
    public static byte[] getParticularDataToPheeze(int body_orientation, int muscle_index, int exercise_index, int bodypart_index,
                                                   int orientation_position,int max_angle,int min_angle,boolean Status){
...
//        }
        ...
        b[6] = (byte) (Status?0xff:0x00);
        if (min_angle == 0) {
            b[7] = 0;  // Handle the case when min_angle is 0
        } else {
            b[7] = (byte) (min_angle >> 8);  // Perform the right shift for other values of min_angle
        }
//        b[7] = (byte) (8 >> (short)min_angle);
        b[8] =  (byte) ((short)min_angle & 0xff);
        b[9] = (byte) (max_angle >> 8);
        b[10] = (byte) ((short)max_angle & 0xff);

        Log.e("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", Integer.toHexString(b[7]));
        Log.e("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", Integer.toHexString(b[8]));
        Log.e("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", Integer.toHexString(b[9]));
        Log.e("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", Integer.toHexString(b[10]));
        Log.e("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", String.valueOf(min_angle));
        Log.e("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", String.valueOf(max_angle));
