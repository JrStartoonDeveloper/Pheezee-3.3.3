...
import com.start.apps.pheezee.activities.LoginActivity;
    ...
    private class InsertAllPatients extends AsyncTask<List<PhizioPatients>, Void, Void> {
        ...
        protected final Void doInBackground(List<PhizioPatients>... lists) {
            ...
            try {
                ...
                email = object.getString("phizioemail");

            } catch (JSONException e) {
                e.printStackTrace();
            }
            String UserStatus = sharedPref.getString("UserStatus", "");
            Log.e("7777777777777777777777777777777777777777777777777777777777777777",UserStatus);
            if(UserStatus.equalsIgnoreCase("Fail")){

            }
            else if (UserStatus.equalsIgnoreCase("Pass")){
...
//                                    object.put("packagetype", results.get(0).getPackagetype());
            ...
            public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                ...
                if (file != null) {
                    ...
                    if (reportDataResponseListner != null) {
                        ...
                        Log.e("hhhhhhhhhhhhhhhhhhhhhh","no report_downloade");
    ...
    public void insertSessionData(SessionData data) {
        Log.e("2222222222222222222222222222222222222222222222222222", String.valueOf(data));
